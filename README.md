...
messages = np.array(
    [[int(x) for x in format(i, f"0{k}b")] for i in range(2**k)]
)
...
## OUTPUT WAVEFORM:
<img width="955" height="748" alt="Screenshot 2026-05-20 142528" src="https://github.com/user-attachments/assets/7feab550-5cfa-4452-b5a3-be03d8ebaad7" />
